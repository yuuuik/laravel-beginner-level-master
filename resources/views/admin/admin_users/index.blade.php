...
@section('content')
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mt-8">
            <a href="{{ route("admin.admin_users.create") }}" class="text-indigo-600 hover:text-indigo-900">Добавить администратора</a>
        </div>
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                    ...
                                    <form action="{{ route("admin.admin_users.destroy", $user->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
